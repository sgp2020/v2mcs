...
@Getter
@Setter
public class ReqGetStockerInfoEntity extends AjaxDataTablesReqBaseEntity {

//    @FieldNameKey(key = "II-005-01-003") public String controllerId = null;
    @FieldNameKey(key = "II-005-01-003") public String tscId = null;
}
