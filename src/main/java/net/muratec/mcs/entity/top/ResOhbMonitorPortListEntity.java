...
/**
 ******************************************************************************
 * @file        ResOhbMonitorPortListEntity.java
 * @brief       OHBモニタポート画面用レスポンスエンティティ
 * @par
 * @author      CSC
 * $Id:         $
 * @attention
...
/**
 ******************************************************************************
 * @brief    OHBモニタポート画面用レスポンスエンティティクラス
 * @par
 * @attention
 * @note
 * ----------------------------------------------------------------------------
 ...
 */
//@formatter:on
public class ResOhbMonitorPortListEntity extends AjaxResBaseEntity {
