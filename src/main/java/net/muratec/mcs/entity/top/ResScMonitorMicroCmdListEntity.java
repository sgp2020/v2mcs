...
/**
 ******************************************************************************
 * @file        ResScMonitorMicroCmdListEntity.java
 * @brief       SCモニタMicroコマンド画面用レスポンスエンティティ
 * @par
 * @author      CSC
 * $Id:         $
 * @attention
...
/**
 ******************************************************************************
 * @brief    SCモニタMicroコマンド画面用レスポンスエンティティクラス
 * @par
 * @attention
 * @note
 * ----------------------------------------------------------------------------
 ...
 */
//@formatter:on
public class ResScMonitorMicroCmdListEntity extends AjaxResBaseEntity {
